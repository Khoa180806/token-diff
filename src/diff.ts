import { TokenizerResult, TokenDiffReport, TokenDeltaStats } from './types.js';
...
function calculatePercentage(current: number, original: number): number {
  if (original === 0) {
...
export function computeDiff(
  ...
  const diffStats: TokenDeltaStats = {
