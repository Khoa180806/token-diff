...
export function formatHuman(report) {
    ...
    // Header row
    lines.push(pc.bold(`${pad('Target', colTarget)} ${pad('Tokens', colTokens)} ${pad('Chars', colChars)} ${pad('Lines', colLines)}`));
    ...
    lines.push(`${pc.bold(pad('Diff', colTarget))} ${paddedTokenDiff} ${paddedCharDiff} ${paddedLineDiff}`);
    lines.push('');
